...
export const MobileMenu: React.FC<MobileMenuProps> = ({className, isOpen}) => {
    return (
        <motion.div
            ...
            className={clsx('opacity-0 h-screen-safari-fix overflow-y-auto pt-16  xs:pt-24 pb-16  bg-s-black w-full inset-0 fixed', className)}>
            <Container className="flex flex-col h-full items-center">
                ...
                <motion.div variants={fadeMotionVariant} className="mt-auto">
                    <div className="w-full text-center mt-auto mb-8 text-lg">
