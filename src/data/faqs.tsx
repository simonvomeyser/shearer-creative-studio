...
export const faqs: FaqType[] = [
    ...
    },
    {
        ...
        answer: `
       <b>Die Anzahlung dient uns zur sicherheit, das du es auch ernst mit uns meinst. </b>
    Wir respektieren eure Zeit somit wollen wir das ihr das auch mit unserer tut. <br><br>
Du kannst deinen Termin 48h/2 Tage vorher kostenlos per Telefon/Mail/WhatsApp stornieren oder verschieben. Für Absagen, die nicht innerhalb unserer Stornofrist liegen, müssen wir die Anzahlung einbehalten, da wir diese Termine so kurzfristig nicht wieder verbucht bekommen.
Um euch durch kurzfristige Terminabsagen anfallende Kosten zu ersparen, seit euch sicher, das ihr euren Termin auch wahnehmen könnt.
